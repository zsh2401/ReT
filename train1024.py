...
model = MusicTransformer(
    vocab_size, embed_dim, num_heads, num_layers, max_len, pad_idx, dff
).to(device)
...
for epoch in range(start_epoch, num_epochs):
    ...
    for batch_inputs, batch_targets in tqdm.tqdm(
        ...
        # 注意力掩码
        src_padding_mask = batch_inputs == pad_idx  # 忽略输入的 PAD
        tgt_padding_mask = tgt_input == pad_idx  # 忽略目标的 PAD
